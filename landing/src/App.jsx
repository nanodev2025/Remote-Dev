    ...
    >
      <span className="grid h-5 w-5 place-items-center rounded-full bg-slate-900/5 ring-1 ring-slate-200">
        ...
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          <path
            d="M12 2c5.52 0 10 4.62 10 10.32 0 4.56-2.87 8.43-6.84 9.8-.5.1-.68-.22-.68-.48v-1.7c0-.58-.19-.96-.4-.15 1.32-.15 2.7-.68 2.7-3.09 0-.69-.23-1.25-.62-1.69.06-.16.27-.83-.06-1.73 0 0-.5-.17-1.64.65a5.5 5.5 0 0 0-3 0c-1.13-.82-1.64-.65-1.64-.65-.33.9-.12 1.57-.06 1.73-.38.44-.62 1-.62 1.69 0 2.4 1.37 2.94 2.68 3.09-.17.16-.33.43-.38.83-.34.16-1.2.46-1.73-.56 0 0-.32-.6-.93-.64 0 0-.6-.01-.04.38 0 0 .4.2.67.97 0 0 .36 1.16 2.01.78v1.3c0 .26-.18.58-.68.48C4.87 20.75 2 16.88 2 12.32 2 6.62 6.48 2 12 2Z"
            fill="currentColor"
            opacity="0.9"
          />
        </svg>
